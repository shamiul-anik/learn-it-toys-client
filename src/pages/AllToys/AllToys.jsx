  ...
  return (
    <div>
      ...
      <section className="max-w-7xl mx-auto mt-12 lg:mt-32 p-4 md:px-0">
        ...
        {/* Search */}
        <form className="flex gap-2 flex-col md:flex-row w-full mx-auto md:w-3/4">
            ...
            <div className="relative w-full">
              ...
              <input value={searchValue} onChange={e => setSearchValue(e.target.value)} type="text" id="search" name="search" className="block w-full p-2 pl-10 text-sm text-slate-800 border border-slate-300 rounded-lg bg-slate-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search by Toy Name" />
            </div>
            <div className="flex">
