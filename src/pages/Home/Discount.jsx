...
const Discount = () => {
  return (
    <section className="mt-16 md:mt-22 max-w-7xl mx-auto rounded-lg bg-white dark:bg-gray-900">
      ...
      {/* <div className="gap-16 items-center border-2 border-slate-200 mt-6 md:mt-12 py-8 px-4 mx-auto lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      ...
      <section className="bg-center mt-6 md:mt-12 rounded-xl bg-no-repeat bg-center bg-cover bg-[url('https://i.ibb.co/zXFnRd7/gallery-image1.jpg')] bg-gray-700 bg-blend-multiply">
