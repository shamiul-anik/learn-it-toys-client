        ...
        <form onSubmit={handlePasswordReset}>
          <div className="!px-6 md:!px-8 !pt-2 card-body">
            ...
            <div className="form-control mt-4">
              ...
              <button type="submit" className="text-white bg-gradient-to-br from-red-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-orange-200 dark:focus:ring-orange-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Reset Password</button>
            </div>
          </div>
        </form>
        <div className="p-6 md:p-8 !pb-8 pt-1 md:pt-2 text-center">
          Go Back to <Link to="/login" className='link link-primary font-semibold transition-all hover:duration-200 text-blue-600 hover:text-blue-700'>Login</Link>
        </div>
